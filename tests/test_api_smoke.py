...
def test_query_with_mocked_retriever_and_model():
    ...
    with (
        patch("api.routes.get_retriever") as mock_get_retriever,
        ...
        # Make request
        request_data = {
            "query": "What does Deutsche Telekom offer?",
            "top_k": 2,
        }
